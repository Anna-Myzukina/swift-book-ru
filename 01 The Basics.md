...
<a href="#p1" >=>Переменные и константы</a><br>
<a href="#p2" >=>Коментарии</a><br>
<a href="#p3" >=>Точка с запятой</a><br>
<a href="#p4" >=>Целые числа</a><br>
<a href="#p5" >=>Числа с плавающей точкой / Floating-Point Numbers</a><br>
<a href="#p6" >=>Тип безопасности и вывод типа</a><br>
<a href="#p7" >=>Числовые литералы / Numeric Literals</a><br>
<a href="#p8" >=>Числовое Преобразование Типа  / Numeric Type Conversion</a><br>
<a href="#p9" >=>Тип Алиасы / Type Aliases</a><br>
<a href="#p10" >=>Логические типы / Booleans</a><br>
<a href="#p11" >=>Кортеж / Tuples</a><br>
<a href="#p12" >=>Optionals</a><br>
<a href="#p13" >=>Обработка ошибок</a><br>
...
<p id="p3"><h2>Точка с запятой</h2></p>
...
<p id="p5"><h2>Числа с плавающей точкой / Floating-Point Numbers</h2></p5>
...
<b>Double</b> имеет точность не менее 15 десятичных цифр, тогда как точность Float может составлять всего 6 десятичных цифр.
...
<p id="p6"><h2>Тип безопасности и вывод типа</h2></p>
...
<p id="p7"><h2>Числовые литералы / Numeric Literals </h2></p>
...
<p id="p8"><h2> Числовое Преобразование Типа  / Numeric Type Conversion </h2></p>
...
<p id="p9"><h2> Тип Алиасы / Type Aliases </h2></p>      
...
например, при работе с данными определенного размера из внешнего источника:   
 ...
 который предоставляет начальное значение 0 для переменной maxAmplitudeFound.       
  ...
  <p id="p10"><h2> Логические типы / Booleans</h2></p>
...
<p id="p11"><h2>Кортеж / Tuples</h2></p>
...
<p id="p13"><h2>Обработка ошибок</h2></p>
